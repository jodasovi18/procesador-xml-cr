...
**Próximo:** **D-150** (débito/crédito/saldo sobre el resumen tributario clasificación-aware; No Deducibles y No Sujeto fuera del crédito fiscal; tiquetes excluidos por Decreto 44739-H) → reconciliación completa de compras cuando estén las reglas reales → subida manual ZIP → **1C** agente local → **1D** frontend (incl. CRUD completo de reglas + auto-preclasificación por CABYS, diferidos de 1B-5) → **1E** reportes Excel/PDF.
